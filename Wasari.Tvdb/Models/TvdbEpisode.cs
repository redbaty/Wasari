...
public record TvdbEpisode(
    ...
    object OverviewTranslations,
    [property: JsonPropertyName("image")]
    string Image,
    [property: JsonPropertyName("imageType")]
    int? ImageType,
    [property: JsonPropertyName("isMovie")]
    int? IsMovie,
    ...
    string LastUpdated,
    [property: JsonPropertyName("finaleType")]
    string FinaleType,
    [property: JsonPropertyName("airsBeforeSeason")]
    int? AirsBeforeSeason,
    [property: JsonPropertyName("airsBeforeEpisode")]
    int? AirsBeforeEpisode,
    [property: JsonPropertyName("year")]
    string Year,
    [property: JsonPropertyName("airsAfterSeason")]
    int? AirsAfterSeason
);